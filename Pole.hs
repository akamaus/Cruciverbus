module Pole(Point(..), Box, mkBox, unbox_p1, unbox_p2, unbox,
            Direction(..), rotate,
            moveAlong, moveAlongAndAcross,
            isSubbox, boxesCrossing, getBoundingBox) where
...
boxesCrossing b1 b2 =
    ...
    in between Hor (unbox_p1 br) (unbox_p2 bl) (unbox_p2 br) &&
